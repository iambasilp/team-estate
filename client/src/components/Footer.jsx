...
const Footer = () => {
   return (
      <section className={`app__footer ${styles.flexCenter} flex-col ${styles.paddingY}`}>
         <div className={`app__footer-content ${styles.flexCenter} w-full mb-8 md:flex-row flex-col`}>
            <div className={`app__footer-content_logo flex-1 flex flex-col justify-start mr-10`}>
               <Link to="/">
            ...
            <div className={`flex-[1.5] flex justify-between flex-row flex-wrap md:mt-0 mt-10`}>
               {footerLinks.map((footerLink, index) => (
                  <div key={index + 1} className="flex flex-col sm:my-0 my-4 min-w-[150px]">
