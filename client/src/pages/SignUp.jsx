      ...
      <div className="mx-auto h-full sm:w-max">
        <div className="m-auto  py-12">
          <div className="mt-12 rounded-3xl border bg-gray-50 dark:border-gray-700 dark:bg-gray-800 -mx-6 sm:-mx-10 p-8 sm:p-10">
            <h3 className="text-2xl font-semibold text-gray-700 dark:text-white">Create new account</h3>
            <OAuth />
            ...
            <form action="" className="mt-10 space-y-8 dark:text-white" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <Link to={"/sign-in"} href="#" type="reset" className="-ml-3 w-max p-3">
                  <span className="text-sm tracking-wide text-blue-600 dark:text-blue-400">Sign in to your account</span>
                </Link>
              </div>
            </form>
          </div>
