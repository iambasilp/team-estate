...
import BasilDev from '../../assets/developer/basil.png'
            ...
            <div className="xl:container mx-auto px-6 md:px-12">
               <div className="mb-20 text-center">
                  ...
                  <p className="text-gray-600 ">
                     ...
                     brightest minds and experienced executives in the real estate business.
                  </p>
                  <div className="mt-10">
                     <Link
                        className="bg-blue-700 hover:bg-gray-800 transition-all font-bold text-white px-6 py-3 rounded-lg"
                        to="/search"
                     >
                        Get Started
                     </Link>
